...
class SimpleText2SQLAgent:
    ...
    def __init__(self, milvus_uri: str = "http://localhost:19533", api_key: str = None):
        """初始化代理"""
    ...
    def query(self, user_question: str) -> Dict[str, Any]:
        ...
        if not self.connection:
            return {"success": False, "error": "数据库未连接", "sql": None, "results": None}
        ...
        while retry_count < self.max_retry_count:
            ...
            if success:
                print("SQL执行成功!")
                return {"success": True, "error": None, "sql": sql, "results": result, "retry_count": retry_count}
            else:
    ...
    def add_example(self, question: str, sql: str):
        ...
        try:
            ...
            # 添加新示例
            data.append({"question": question, "sql": sql, "database": "sqlite"})
