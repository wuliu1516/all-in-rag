...
class SimpleKnowledgeBase:
    ...
    def __init__(self, milvus_uri: str = "http://localhost:19530"):
        ...
        self.embedding_function = BGEM3EmbeddingFunction(model_name=model_path, use_fp16=False, device="cpu")
    ...
    def _setup_collection(self):
        ...
        # 创建集合
        self.client.create_collection(collection_name=self.collection_name, schema=schema, consistency_level="Strong")
    ...
    def _insert_data(self, contents: List[str], types: List[str]):
        ...
        for i in range(len(contents)):
            data_to_insert.append({"content": contents[i], "type": types[i], "dense_vector": embeddings["dense"][i]})
    ...
    def search(self, query: str, top_k: int = 5) -> List[Dict[str, Any]]:
        ...
        for hit in search_results[0]:
            results.append(
                {"content": hit["entity"]["content"], "type": hit["entity"]["type"], "score": hit["distance"]}
            )
